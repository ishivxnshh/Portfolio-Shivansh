        ...
        >
            <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
                ...
                <div className="hidden md:flex items-center gap-4">
                    ...
                    <button className="relative text-sm font-medium text-white hover:text-[#00ff00] transition-all duration-300 px-4 py-2 rounded-lg hover:bg-white/5 group overflow-hidden">
                        <span className="relative z-10">Log In</span>
                    </button>
                    <button className="relative text-sm font-bold bg-gradient-to-r from-[#00ff00] to-[#00cc00] text-black px-6 py-2.5 rounded-full hover:shadow-[0_0_30px_rgba(0,255,0,0.5)] transition-all duration-300 transform hover:-translate-y-0.5 hover:scale-105 overflow-hidden group">
            ...
            >
                <div className="p-6 flex flex-col gap-2">
                    ...
                    <div className="flex flex-col gap-3">
                        <button className="text-center text-white font-medium hover:text-[#00ff00] py-3 rounded-xl border border-white/10 hover:border-[#00ff00]/30 hover:bg-white/5 transition-all duration-300">
                            Log In
                        </button>
                        <button className="text-center font-bold bg-gradient-to-r from-[#00ff00] to-[#00cc00] text-black py-3 rounded-xl hover:shadow-[0_0_20px_rgba(0,255,0,0.4)] transition-all duration-300 transform hover:scale-105">
                            Sign Up
                        </button>
                    </div>
                </div>
